...
import {dataTimeFormat} from "@/utils/date";
  ...
  <div class="big_model_role_preview_view">
    ...
    <div class="body">
      <div class="item">
        ...
        <div class="main">
          <div class="date">{{ dataTimeFormat(new Date().toLocaleString())}}</div>
          <div class="content">
            <md-preview :model-value="props.data.prologue" :theme="store.themeString"></md-preview>
          </div>
        </div>
      </div>
    </div>
