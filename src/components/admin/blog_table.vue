              ...
              <template v-for="item in props.columns">
                ...
                <a-table-column  :title="item.title as string" v-else>
                  ...
                  <template #cell="{record}" v-else-if="item.slotName === 'created_at'">
                    <span>{{ dataTimeFormat(record.created_at) }}</span>
                  </template>
...
import {type baseResponse, type paramsType, type listDataType, defaultOptionApi} from "@/api";
import {Message} from "@arco-design/web-vue";
import type {TableColumnData, TableRowSelection,TableData} from "@arco-design/web-vue";
