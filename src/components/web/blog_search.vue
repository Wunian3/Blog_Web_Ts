<template>
  <a-modal title="全文搜索" width="40%" v-model:visible="visible" :footer="false" body-class="blog_search_body">
    <div class="head">
...
import {articleSearchApi, type articleSearchType} from "@/api/article_api.ts";
